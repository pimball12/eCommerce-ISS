			...
			<div class="box-body table-responsive ">
				<table class="table table-hover">
		            <tbody>
						...
						<c:forEach var="itemGrade" items="${grade.getItensGrade()}">
		            	<tr>
							...
							<td><a href="#">
								<span id="${itemGrade.getId()}" class="label label-danger delete_button" data-toggle="modal" data-target="#delete_modal">
								Excluir</span>
							</a></td>			 		
						</tr> 
						</c:forEach>
